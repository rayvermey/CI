...
# Path to your Snap installation.
export PATH="$HOME/.emacs.d/bin:/home/ray/scripts/:$PATH"
...
alias pconf='sudo vi /etc/pacman.conf'
alias mkpkg='sudo vi /etc/makepkg.conf'
alias ngrub='sudo vi /etc/default/grub'
alias smbconf='sudo vi /etc/samba/smb.conf'
alias nmirrorlist='sudo vi /etc/pacman.d/mirrorlist'
